...
from topface.model.custom_objects.js_popups.fb_invite_popup import FbInviteFriendsPopup
from topface.model.custom_objects.js_popups.sexy_popup import SexyPopup
from topface.model.object_model import ObjectModel

__author__ = 'ngavrish'

class AuthForm(ObjectModel):
    """
